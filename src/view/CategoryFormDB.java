...
public class CategoryFormDB extends javax.swing.JInternalFrame {
    ...
    void loadCategoryListToTable() {
        ...
        for (CategoryOfProduct ca : cateModel.getAll()) {
            dtm.addRow(new Object[]{ca.getId(), ca.getCateName()});
        }
    ...
    private void btncreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncreateActionPerformed
        ...
        if (txtName.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Category name cannot be empty!","Error",0);
            return;
        }

        CategoryOfProduct category = new CategoryOfProduct();
        category.setCateName(txtName.getText());
        category.setIsActive(true);

        if (!cateModel.addNew(category)) {
            JOptionPane.showMessageDialog(null, "Failed to add new Category!","Error",0);
        } else {
            JOptionPane.showMessageDialog(null, "Category added successfully!","Success",1);
            loadCategoryListToTable();
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (!cateModel.edit(category)) {
            JOptionPane.showMessageDialog(null, "Failed to update Category!","Error",0);
        } else {
            JOptionPane.showMessageDialog(null, "Category updated successfully!","Success",1);
            txtId.setText(" ");
            loadCategoryListToTable();
        }
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        loadCategoryListToTable();
        JOptionPane.showMessageDialog(null, "Category deleted successfully!","Success",1);
        txtId.setText(" ");
